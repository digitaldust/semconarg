 ...
 */
public class KnowledgeEvolution extends DefaultReporter {
    ...
    public LogoList report(Argument[] argmnts, Context cntxt) throws ExtensionException, LogoException {
        ...
        Iterator<LogoList> iterator = SemConArg.alreadyKnowWhen.keySet().iterator();
        ...
        while(iterator.hasNext()){
            ...
            Iterator<Double> iterator1 = SemConArg.alreadyKnowWhen.get(semExt).iterator();
